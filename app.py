...
# ======================== 1. إعدادات قاعدة البيانات المستقرة ========================
app = Flask(__name__)
DB_PATH = "trading_system_final.db"

def get_db_connection():
    # استخدام check_same_thread=False لحل مشكلة Internal Server Error
...
async def main_engine():
    while True:
        try:
            ...
            # تصفية أزواج USDT فقط واستبعاد العملات المكررة
...
def index():
    ...
    try:
        ...
        for r in cursor:
            ...
            closed_rows += f"<tr><td>{r[8]}</td><td>{r[0]}</td><td>{final_usd:+.2f}$</td><td>{r[5]}</td></tr>"
    finally: conn.close()
    ...
    <style>
        ...
        <div class="box" style="border-top-color: #00ff00;">
            ...
            <table>
                <thead><tr><th>الدخول</th><th>العملة</th><th>سعر الدخول</th><th>الربح/الخسارة الصافي ($)</th></tr></thead>
